...
#endif
TUNABLE(SOFTMAX_TEMPERATURE, 1.0f, 1.0f, 3.0f, 0.08);
TUNABLE(ROOT_EXPLORATION_CONSTANT, 1.3f, 0.5f, 2.5f, 0.05f);
TUNABLE(EXPLORATION_CONSTANT, 1.0f, 0.5f, 2.5f, 0.05f);
TUNABLE(CPUCT_VISIT_SCALE, 8192, 2048, 16384, 256);
TUNABLE(CPUCT_VISIT_SCALE_DIVISOR, 8192, 2048, 16384, 256);
TUNABLE(GINI_BASE, 0.5f, 0.0f, 1.5f, 0.05f);
TUNABLE(GINI_MULTIPLIER, 1.5f, 0.5f, 3.0f, 0.1f);
TUNABLE(GINI_MAXIMUM, 2.25f, 1.25f, 3.25f, 0.1f);
TUNABLE(POLICY_HISTORY_DIVISOR, 16384, 8192, 32768, 1024);
