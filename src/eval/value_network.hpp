...
constexpr usize L1_REG_SIZE = util::NATIVE_SIZE<i16>;
...
using i16Vec = util::SimdVector<i16, L1_REG_SIZE>;
using i8Vec = util::SimdVector<i8, L1_REG_SIZE>;

struct alignas(util::NATIVE_VECTOR_ALIGNMENT) ValueNetwork {
    union {
        util::MultiArray<i16Vec, 2, 2, 2, 6, 64, L1_SIZE / L1_REG_SIZE> ft_weights_vec;
