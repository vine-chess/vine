...
struct alignas(util::NATIVE_VECTOR_ALIGNMENT) ValueNetwork {
    ...
    union {
        util::MultiArray<util::SimdVector<f32, L3_REG_SIZE>, L2_SIZE, L2_SIZE / L2_REG_SIZE> l2r_weights_vec;
        util::MultiArray<f32, L2_SIZE, L2_SIZE> l2r_weights;
    };
    util::MultiArray<f32, L2_SIZE> l2r_biases;
